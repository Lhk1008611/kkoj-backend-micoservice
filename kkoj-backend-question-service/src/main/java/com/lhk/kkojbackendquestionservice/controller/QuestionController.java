package com.lhk.kkojbackendquestionservice.controller;

import cn.hutool.json.JSONUtil;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.lhk.kkojbackendcommon.annotation.AuthCheck;
import com.lhk.kkojbackendcommon.common.BaseResponse;
import com.lhk.kkojbackendcommon.common.DeleteRequest;
import com.lhk.kkojbackendcommon.common.ErrorCode;
import com.lhk.kkojbackendcommon.common.ResultUtils;
import com.lhk.kkojbackendcommon.constant.UserConstant;
import com.lhk.kkojbackendcommon.exception.BusinessException;
import com.lhk.kkojbackendcommon.exception.ThrowUtils;
import com.lhk.kkojbackendmodel.model.dto.question.*;
...
import com.lhk.kkojbackendmodel.model.vo.QuestionVO;
...
public class QuestionController {
    ...
    public BaseResponse<Boolean> deleteQuestion(@RequestBody DeleteRequest deleteRequest, HttpServletRequest request) {
        ...
        // 仅本人或管理员可删除
        if (!oldQuestion.getCreatorId().equals(user.getId()) && !userFeignClient.isAdmin(request)) {
    ...
    public BaseResponse<Question> getQuestionById(long id , HttpServletRequest request) {
        ...
        User loginUser  = userFeignClient.getLoginUser(request);
        if(!question.getCreatorId().equals(loginUser.getId()) && !userFeignClient.isAdmin(loginUser)){
            throw new BusinessException(ErrorCode.NO_AUTH_ERROR);
        }
    ...
    public BaseResponse<Boolean> editQuestion(@RequestBody QuestionEditRequest questionEditRequest, HttpServletRequest request) {
        ...
        ThrowUtils.throwIf(oldQuestion == null, ErrorCode.NOT_FOUND_ERROR);
        // 仅本人或管理员可编辑
        if (!oldQuestion.getCreatorId().equals(loginUser.getId()) && !userFeignClient.isAdmin(loginUser)) {
            throw new BusinessException(ErrorCode.NO_AUTH_ERROR);
        }
        boolean result = questionService.updateById(question);
        return ResultUtils.success(result);
